...
public class MybatisConfig {
	// datasource, sqlSessionFactoryBean, trasactionManager(sqlSessionTemplate)
	
	
	/*
	 * project, server의 물리적 위치의 파일을 읽거나 기록할때 위치를 찾는 용도의 클래스이다.
	 */
	@Autowired
...
//		} catch (IOException e) {
//			log.debug("mapper 파일 읽는 중 ERROR 발생");
//		}
