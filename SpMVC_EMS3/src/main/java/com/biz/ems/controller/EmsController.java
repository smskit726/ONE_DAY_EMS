...
//		model.addAttribute("EMS", emsVO);
	 ...
	 * id 값을 변수로 넘기면서 update, GET로 호출이된다.
	 * id 값으로 findById() 조회를 해서 EmsVO를 DB로부터 Select하고 그 결과를
	 * model에 담아서 다시 ems-write.jsp로 보내기
	 */
